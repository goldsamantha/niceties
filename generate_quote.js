...
function getTweetTwoCorpus(corpus1, corpus2) {
...
function getTweetSingleCorpus(corpus) {
...
getTweetSingleCorpus(singleCorpus);

getTweetTwoCorpus(quotes1, quotes2); //, wl1, wl2);
